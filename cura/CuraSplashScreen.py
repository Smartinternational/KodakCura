...
class CuraSplashScreen(QSplashScreen):
    ...
    def drawContents(self, painter):
        ...
        painter.drawText(190, 490, 330 * self._scale, 230 * self._scale, Qt.AlignLeft | Qt.AlignTop, version[0])
        if len(version) > 1:
        ...
        #painter.setPen(pen)
        #painter.drawArc(160, 230, 32 * self._scale, 32 * self._scale, self._loading_image_rotation_angle * 16, 300 * 16)
        ...
        if self._current_message:
            ...
            painter.setPen(pen)
            painter.setFont(font)
            painter.drawText(330, 480, 170, 64,
