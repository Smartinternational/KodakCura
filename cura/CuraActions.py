...
class CuraActions(QObject):
    ...
    def openDocumentation(self):
        ...
        event = CallFunctionEvent(self._openUrl, [QUrl("https://digilab.dremel.com/support/3d-support")], {})
        Application.getInstance().functionEvent(event)

    @pyqtSlot()
    def openBugReportPage(self):
        event = CallFunctionEvent(self._openUrl, [QUrl("https://3dprintersupport.dremel.com/hc/en-us")], {})
        Application.getInstance().functionEvent(event)
